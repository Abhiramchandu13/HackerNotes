...
- **Next-Generation Firewalls (NGFW):** Advanced firewalls that go beyond Port/IP blocking and inspect Layer 7 Application data (discussed fully in the [Next-Gen Firewalls note](next-gen-firewalls.md)).
...
- [Network Segmentation](../09-network-security/network-segmentation.md)
